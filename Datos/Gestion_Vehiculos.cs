    ...
    public class Gestion_Vehiculos
    {
        ...
        public string ActualizarVehiculo(Vehiculo vehiculo)
        {
            ...
            try
            {
                ...
                comando.Parameters.Add("result", OracleDbType.Varchar2, 1000).Direction = ParameterDirection.ReturnValue;
                comando.Parameters.Add("p_placa", OracleDbType.Varchar2).Value = vehiculo.Placa;
                comando.Parameters.Add("p_nuevo_tp_vehiculo", OracleDbType.Varchar2).Value = vehiculo.TipoVehiculo;
                comando.Parameters.Add("p_nuevo_modelo", OracleDbType.Varchar2).Value = vehiculo.Modelo;
                comando.Parameters.Add("p_nueva_marca", OracleDbType.Varchar2).Value = vehiculo.Marca;
                comando.Parameters.Add("p_nuevo_cilindraje", OracleDbType.Varchar2).Value = vehiculo.Cilindraje;
                comando.Parameters.Add("p_nueva_version", OracleDbType.Date).Value = vehiculo.Version;
        ...
        public List<Vehiculo> ObtenerDatosVehiculo()
        {

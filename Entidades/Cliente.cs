...
namespace Entidades
{
    public  class Cliente : Persona
    {
        ...
        public Cliente(string cedula, string nombre, string telefono, string direccion, DateTime ingresovehiculo, DateTime salidavehiculo, string cedulaempleado, string placaVihiculo, float precioAcordado) : base(cedula, nombre, telefono, direccion)
        {
